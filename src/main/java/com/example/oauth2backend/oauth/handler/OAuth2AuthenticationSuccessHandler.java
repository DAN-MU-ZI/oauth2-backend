...
import static com.example.oauth2backend.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
import static com.example.oauth2backend.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REFRESH_TOKEN;

import com.example.oauth2backend.api.entity.user.UserRefreshToken;
...
import com.example.oauth2backend.oauth.info.OAuth2UserInfoFactory;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private boolean hasAuthority(final Collection<? extends GrantedAuthority> authorities, final String authority) {
        if (authorities == null) {
            return false;
        }
